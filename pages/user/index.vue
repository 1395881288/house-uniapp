<template>
  <view class="container">
    <view class="system-setting" @click.stop="navTo('/pages/house/setting/index')">
      <u-icon name="setting" color="#939393" size="25"></u-icon>
    </view>
    <view class="user-header">
      <view class="user-info" @click.stop="navTo('/pages/house/users/user_info/index')"><!--  -->
...
<!-- 	  <u-cell class="fun-item" size="large" icon="coupon" title="优惠券" isLink @click="navTo('/pages/house/users/coupon/coupon',{login:true})"></u-cell> -->
...
<!--      <u-cell class="fun-item" size="large" icon="plus-people-fill" title="邀请好友赢现金" isLink  @click="navTo('/pages/house/users/user_spread_user/index',{login:true})"></u-cell>
 -->      <u-cell class="fun-item" size="large" icon="list-dot" title="我的租约" isLink @click="navTo('/pages/house/users/lease/lease',{login:true})"></u-cell>
<!--      <u-cell class="fun-item" size="large" icon="order" title="测试支付" isLink @click="gotopay"></u-cell> -->
      <u-cell class="fun-item" size="large" icon="calendar" title="我的预定" isLink @click="navTo('/pages/house/users/booking/index',{login:true})"></u-cell>
	  <u-cell class="fun-item" size="large" icon="info-circle" title="在线报修" isLink @click="navTo('/pages/house/users/repair/repair',{login:true})"></u-cell>
...
export default {
  ...
  methods: {
	...
	gotopay(){
		uni.navigateTo({
		  url: `/pages/house/users/lease/orderPayStatus?order_id=166`
		});
		
/* 		const returnUrl = encodeURIComponent('/pages/house/users/orderPayStatus?order_id=' + 1);
		const payOrderId =2
		uni.navigateTo({
